  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'tms-dot-pulse': {
          '0%, 100%': { boxShadow: '0 0 0 0 hsl(var(--accent-brand) / 0.4)' },
          '50%': { boxShadow: '0 0 0 6px hsl(var(--accent-brand) / 0)' },
        },
        'tms-glow-breathe': {
          '0%, 100%': { boxShadow: '0 0 8px 0 hsl(var(--accent-brand) / 0.15)' },
          '50%': { boxShadow: '0 0 20px 4px hsl(var(--accent-brand) / 0.25)' },
        },
        'tms-float': {
      ...
      animation: {
        ...
        'tms-dot-pulse': 'tms-dot-pulse 2s ease-in-out infinite',
        'tms-glow-breathe': 'tms-glow-breathe 3s ease-in-out infinite',
        'tms-float': 'tms-float 3s ease-in-out infinite',
        'tms-shimmer': 'tms-shimmer 2s linear infinite',
      }
    }
  },
